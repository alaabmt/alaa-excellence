(() => {
  ...
  function applyLang(){ document.documentElement.lang = state.lang; document.documentElement.dir = state.lang === 'ar' ? 'rtl' : 'ltr'; langBtn.textContent = state.lang === 'ar' ? 'English' : 'العربية'; document.title = t('How You Learn | Learning Style Profile | Tamayuz 10X','كيف تتعلّم؟ | بصمتك في التعلّم | التميّز 10X'); }
